...
//   }, []);
    ...
    useEffect(() => {
      ...
      const updatePackagerequest = (action: string) => {
        ...
        let errorMessage = "";
        if ((!selectedOptions[0] && action === "Approved")) {
          errorMessage =
            "Assign Packer Field.";
 ...
 onClose()
  ...
  />
        ...
        <div className="fields_gap">
          <FormControl className="req_fields">
            <InputLabel id="assignpacker">Assign Packer</InputLabel>
            <Select
...
<Button  className='cancel_button' onClick={handleClickOpen} >
      ...
      <Button className='submit_button' onClick={()=>updatePackagerequest("Approved")} variant="contained">Slot in Calendar</Button>
