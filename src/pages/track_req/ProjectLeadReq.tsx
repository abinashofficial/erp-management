...
import { ProjectLeadApprovalRequest } from "../raise-req/ProjectLeadApprovalReq";
...
export function PackingRequest() {
    const { projectLeadApprovalRequestData} = useContext(locateContext);
  ...
  // const data = projectLeadApprovalRequestData // Provide your data here
  ...
  const filteredRows = projectLeadApprovalRequestData.filter((row: any) => {
...
// );
  ...
  />
      ...
      <ProjectLeadApprovalRequest open={visibleReq} onClose={()=>userAction(selectItem)} item = {selectItem}/>
