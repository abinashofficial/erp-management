...
const CustomStepper: React.FC<Props> = (props) => {
  ...
  const generateLabels = () => {
    const labels: Label[] = [
      ...
      { text: 'Inventory Lead', marginLeft: '25px', status: props.inventoryLeadStatus, label_order: 3 },
    ...
    return labels.map((label, index) => {
      ...
      return (
        <div className="container" key={index} style={{ backgroundImage: `url(${background_image})`, backgroundSize: '200px 71px', backgroundRepeat: 'no-repeat' }}>
