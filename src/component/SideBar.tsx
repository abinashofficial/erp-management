...
const SideBar: React.FC<SideBarProps> = ({
  ...
  const [openInventoryLeadRaise, setOpenInventoryLeadRaise] = useState(false);
  ...
  const [userMenuItems] = useState<MenuItem[]>([
    ...
    {
      path: "/Packaging_Management/trackreq",
      name: "Track Request",
      icon: <GpsFixedIcon/>,
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          name: "Flight Components",
          icon: <HiOutlineHandRaised />,
        },
        {
          path: "/consumablecomponents",
  ...
  const [inventoryLeadMenuItems] = useState<MenuItem[]>([
    ...
    },
    {
      ...
      name: "Inventory Lead",
      // icon: <img className="menu_icons" src={Inventory} alt="humanImage"/>,
  ...
  const [packerMenuItems] = useState<MenuItem[]>([
    ...
    {
      path: "/Packaging_Management/viewreq",
      name: "View Request",
      // icon: <img className="menu_icons" src={Raise} alt="humanImage"/>,
